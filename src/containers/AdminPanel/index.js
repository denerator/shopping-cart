  ...
  render() {
    return (
      <Modal
        ...
        trigger={
          this.state.isOpened ? (
            <button className="floatBtn" onClick={this.visibilityToggle}>
              -
            </button>
          ) : (
            <button className="fixed floatBtn" onClick={this.visibilityToggle}>
              +
            </button>
          )
        }
      ...
      >
        ...
        <form className="form">
          <input
            ...
            onChange={(e) => this.handleInput(e, 'inputTitle')}
            type="text"
          />
          <input
            className="form-item"
            ...
            onChange={(e) => this.handleInput(e, 'inputCategory')}
            type="text"
          />
          <input
            className="form-item"
            ...
            onChange={(e) => this.handleInput(e, 'inputPrice')}
            type="number"
          />
        </form>
        <Button
